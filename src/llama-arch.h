...
enum llm_kv {
    ...
    LLM_KV_HGRNBIT_HEAD_DIM,
    LLM_KV_HGRNBIT_ACT_QUANT_MODE,
    LLM_KV_HGRNBIT_FRAC_BITS,
...
enum llm_tensor {
    ...
    LLM_TENSOR_HGRN_IPROJ,
    LLM_TENSOR_HGRN_FPROJ,
    LLM_TENSOR_HGRN_GPROJ,
    LLM_TENSOR_HGRN_OPROJ,
    LLM_TENSOR_HGRN_GATEPROJ,
    LLM_TENSOR_HGRN_DOWNPROJ,
    LLM_TENSOR_HGRN_GNORM,
    LLM_TENSOR_HGRN_LOWER_BOUNDS,
    LLM_TENSOR_ATTN_Q_A,
    LLM_TENSOR_ATTN_Q_B,
